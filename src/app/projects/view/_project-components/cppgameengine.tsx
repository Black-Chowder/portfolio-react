...
function Journey() {
    return (
        <>
            ...
            <p className="my-3">And just like that, a month had passed and my game was finished. I say "just like that" in hindsight, but progress felt slow considering my initial goal. As mentioned before, I left many features out that could have made the game a full steam releasable game, but the codebase got a bit too messy towards the end as I was just hacking things together to get it done. I knew that if I were to add all these other features, I would have to refactor a lot of code anyway. In the future, I expect I will remake the game using SDL2 rather than SFML, and develop the game with all my features in mind from the get-go, but for now I'm ready to move on to other projects.</p>
        </>
    )
}
